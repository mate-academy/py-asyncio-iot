...
class IOTService:
    ...
    async def run_program(self, program: list[Message]) -> None:
        ...
        separated_program = {msg.device_id: [] for msg in program}
        for msg in program:
            separated_program[msg.device_id].append(msg)

        coroutines = [
            self.run_sequence(*messages)
            for messages in separated_program.values()
        ]
    ...
    async def run_sequence(self, *messages: Message) -> None:
