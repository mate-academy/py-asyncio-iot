...
class IOTService:
    ...
    async def run_program(self, program: list[Message]) -> None:
        ...
        parallels, sequences = program
        await run_parallel(*[self.send_msg(parallel) for parallel in parallels])
        await run_sequence(*[self.send_msg(sequence) for sequence in sequences])
