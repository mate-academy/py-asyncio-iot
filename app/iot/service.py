...
class IOTService:
    ...
    async def unregister_device(self, device_id: str) -> None:
        task_disconnect = asyncio.create_task(self.devices[device_id].disconnect())
    ...
    async def send_msg(self, msg: Message) -> None:
        task_message = asyncio.create_task(self.devices[msg.device_id].send_message(msg.msg_type, msg.data))
        await task_message
